...
for i=1:size(a,2),
    ...
    if i==1,
        %ylabel({'Marine-terminating';'volume loss (mm SLE)'},'fontsize',fs,'fontname',fn,'interpreter',fi);
        ylabel({'Retreat mask';'volume (mm SLE)'},'fontsize',fs,'fontname',fn,'interpreter',fi);
    end
%    if i==6,
...
%print('-dpng','-r300','attribibution_ogr.png');
