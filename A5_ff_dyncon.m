...
for i=1:ln
    test = eval(['isfield(li.' aexp '{i}, ''dyncon'')']);
    if test
        eval(['dat = li.' aexp '{i}.dyncon.*maxmask0;']);
...
print('-r300','-dpng', ['Figures/A5_ff_' aexp '_dyncon_mean' '_' num2str(ln)] );
...
axis equal
text(352,-20,'m','Interpreter','Tex','FontSize',20)
print('-r300','-dpng', ['Figures/A5_ff_' aexp '_dyncon_std' '_' num2str(ln)] );
